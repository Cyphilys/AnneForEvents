...
const Prestations = () => (
  <Layout page='2'>
    ...
    <div style={{ position: "relative"}}>
      ...
      <div style={{backgroundColor: "white",width: "80%", position: "absolute", marginTop: "-100px", marginLeft: "10%"}}>
        <div style={{border: "solid 1px #ccc", textAlign: "center", margin: "30px", padding: "20px"}}>
          ...
          <p>Pour vous assurer la qualité optimale que mérite votre évènement, AnneForEvents a
            ...
            des manèges, de la pyrotechnique, de la reconstitution historique… Tout est possible !
            ...
            besoins, votre espace, votre budget.
            ...
            recyclable…) et dans les différents ateliers. Tout peut s’inventer, tout est unique !
